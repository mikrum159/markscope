...
| [Public release shape](plans/public-release-shape/shape.md)       | Current working state: hardening, documentation, and making the repository public. [Log](plans/public-release-shape/log.md) holds the history.                                                   |
